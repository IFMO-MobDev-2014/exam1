package ru.ifmo.md.exam1.contentprovider;
...
import ru.ifmo.md.exam1.database.TodoDatabaseHelper;
...
public class MyTodoContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "ru.ifmo.md.exam1.contentprovider";
